...
function createPlaceMutation(arg0: { variables: { keywords: string; placeName: string; types: string; userRatingsTotal: number; rating: number; priceLevel: number; isClient: boolean; lat: number; lng: number; description: string; formattedAddress: string; }; }) {
