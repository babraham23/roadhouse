...
let maxheight = 2340;
let maxwidth = 4160;
export const getPlacesPhotos = (photo_reference: any) => `https://maps.googleapis.com/maps/api/place/photo?maxwidth=${maxwidth}&maxheight=${maxheight}&photo_reference=${photo_reference}&key=${API_KEY}`;
