...
export type CreateUserMutation = {
    ...
    createUser: {
        ...
        roleSubCategory?: string | null | undefined;
        profilePicture?: string | null | undefined;
        mobileNumber?: string | null | undefined;
        holidayAllowance?: number | null | undefined;
...
export type CreateUserSessionMutation = {
    __typename?: 'Mutation';
    createUserSession: { __typename?: 'AuthSessionClass'; accessToken: string; expiresIn: number; idToken: string; issuedAt: number; refreshToken: string };
};
...
export type AllInventoryRequestsQuery = {
    __typename?: 'Query';
    allInventoryRequests: Array<{ __typename?: 'InventoryRequest'; title: string; description: string; userId: string; status: number }>;
};
...
export const CreateUserSessionDocument = gql`
    mutation CreateUserSession($refreshToken: String!, $issuedAt: Float!, $idToken: String!, $expiresIn: Float!, $accessToken: String!) {
        createUserSession(refreshToken: $refreshToken, issuedAt: $issuedAt, idToken: $idToken, expiresIn: $expiresIn, accessToken: $accessToken) {
            accessToken
            expiresIn
            idToken
            issuedAt
